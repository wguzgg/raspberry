package com.jajb.web.resources;
...
import com.jajb.annotation.SearchWrapper;
import com.jajb.data.Pagination;
import com.jajb.data.dto.ResultWrapper;
import com.jajb.data.entity.IEntity;
import com.jajb.data.entity.IIDEntity;
import com.jajb.service.ISearch;
import com.jajb.service.IService;
import com.jajb.util.JsonMapperFactory;
...
public class JajbResource {
    ...
    public Response create(@PathParam("entityName") String entityName, String json) throws Exception {
    	Class clazz = serviceManager.getEntity(entityName);
   		IEntity obj = mapperFactory.getMapper().readValue(json, clazz);
   		IService service = serviceManager.getService(entityName);
